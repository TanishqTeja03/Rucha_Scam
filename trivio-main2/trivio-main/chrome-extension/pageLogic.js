...
async function get_questions() {
    ...
    console.log("📺 Sending video URL from pageLogic.js:", videoUrl);
    ...
    try {
        ...
        console.log("✅ Questions received in pageLogic.js:", response);
        return response.timestamp;
    } catch (error) {
        console.error("❌ Error in pageLogic.js get_questions():", error);
        throw error;
    }
}
